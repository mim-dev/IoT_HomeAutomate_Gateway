 ...
 * @author Luther
 */
public class TransmissionStartingView implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("Encounter exception of type[" + e.getClass().toString() + "] from TransmissionStartingView.  Exception says:[" + e.getMessage() + "].");
